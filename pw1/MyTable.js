...
class MyTable extends THREE.Object3D {
    ...
    constructor(app, tableMaterial) {
        ...
        leg1Mesh.position.set(1, 0.5, 0.5);
        this.add(leg1Mesh);

        const leg2Mesh = new THREE.Mesh(legGeometry, tableMaterial);
        leg2Mesh.position.set(1, 0.5, -0.5);
        this.add(leg2Mesh);

        const leg3Mesh = new THREE.Mesh(legGeometry, tableMaterial);
        leg3Mesh.position.set(-1, 0.5, -0.5);
        this.add(leg3Mesh);

        const leg4Mesh = new THREE.Mesh(legGeometry, tableMaterial);
        leg4Mesh.position.set(-1, 0.5, 0.5);
        this.add(leg4Mesh);

        const topGeometry = new THREE.BoxGeometry( 2.2, 0.1, 1.2);
